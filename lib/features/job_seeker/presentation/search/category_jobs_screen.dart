// features/job_seeker/presentation/job/category_jobs_screen.dart
...
class CategoryJobsScreen extends StatefulWidget {
  ...
  const CategoryJobsScreen({super.key, required this.categoryId});
...
class _CategoryJobsScreenState extends State<CategoryJobsScreen> {
 ...
 Future<void> _loadCategoryData() async {
  ...
  try {
    // You can load category details if needed
